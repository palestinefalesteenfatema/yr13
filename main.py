...
# class lol(customtkinter.CTkFrame):
...
#         self.app.columnconfigure((0,1,2,3,4,5,6,7,8), weight=1, uniform='x')
#         self.app.rowconfigure((0,1,2,3,4,5,6,7), weight=1, uniform='x')
#         self.app.title('Waffle cafe')
#         # #navbar
#     def home(self):
#         self.smoothies_frame.place_forget()
#         self.iced_choclate_frame.place_forget()
#         self.classic_waffle_frame.place_forget()
#         self.bubble_waffle_frame.place_forget()
#         self.waffle_bites_frame.place_forget()
#         self.waffle_cake_frame.place_forget()
#         self.waffle_fries_frame.place_forget()
#         self.home_page_frame.place(x=1, y=1, relwidth=1, relheight=1)
#         self.menu_page_frame.place_forget()
#     def menu_bt(self):
#         self. smoothies_frame.place_forget()
#         self. iced_choclate_frame.place_forget()
#         self. classic_waffle_frame.place_forget()
...
#         self. menu_page_frame.place(x=1, y=1, relwidth=1, relheight=1)
#     def login_page_bt(self):
#         self.smoothies_frame.place_forget()
#         self.iced_choclate_frame.place_forget()
#         self.classic_waffle_frame.place_forget()
#         self.bubble_waffle_frame.place_forget()
...
#         self.waffle_fries_frame.place_forget()
#         self.home_page_frame.place_forget()
#         self.login_page_frame.place(x=1, y=1, relwidth=1, relheight=1)
#     #home page frame
#         class four(customtkinter.CTk):
#             def __init__(self):
#                 super().__init__()
#         global home
#         global menu_bt
#         global login_page_bt
#         self.home_page_frame = customtkinter.CTkScrollableFrame(app)
#         self.home_page_frame.place(x=1, y=1, relwidth=1, relheight=1)
#     #menu page frame
#         self.menu_page_frame = customtkinter.CTkScrollableFrame(app)
#     #login page
...
#
# #navbar buttons
#         self.home_button = customtkinter.CTkButton(app, text ="Home", command= home).grid(row=0,column=5)
#         self.menu_button = customtkinter.CTkButton(app, text ="menu", command= menu_bt).grid(row=0, column=6)
#         self.login_button = customtkinter.CTkButton(app, text ="Login", command= login_page_bt).grid(row=0, column=7)
#
...
#     # #slide
#     #     self.image1 = customtkinter.CTkImage(light_image=Image.open("image.png"), size=(910,500))
#     #     self.image1_label = customtkinter.CTkLabel(home_page_frame, text="", image=image1 )
#     #     self.image1_label.grid(row=1, column=1)
#     # #menu
# #
# #     #classic waffle
# #     def classic_waffle(self):
# #         global price
...
bubble_waffle_frame = customtkinter.CTkScrollableFrame(app, width=750, border_width=2)
image3 = customtkinter.CTkImage(light_image=Image.open("bubblewl.png"), size=(200,200))
image3_button = customtkinter.CTkButton(menu_page_frame, text="",fg_color= "white",hover_color="lightgray", image=image3, command= bubble_waffle )
image3_button.grid(row=3, column=2)
#bananas
banana_radio = customtkinter.StringVar()
...
def waffle_bites():
    ...
    print(price)
waffle_bites_frame = customtkinter.CTkScrollableFrame(app, width=750, border_width=2)
image5 = customtkinter.CTkImage(light_image=Image.open("bites.png"), size=(200,200))
image5_button = customtkinter.CTkButton(menu_page_frame, text="",fg_color= "white",hover_color="lightgray", image=image5, command= waffle_bites)
image5_button.grid(row=4, column=1)
...
waffle_cake_frame = customtkinter.CTkScrollableFrame(app, width=750, border_width=2)
image3 = customtkinter.CTkImage(light_image=Image.open("cake.png"), size=(200,200))
image3_button = customtkinter.CTkButton(menu_page_frame, text="",fg_color= "white",hover_color="lightgray", image=image3, command= waffle_cake )
image3_button.grid(row=4, column=2)
#bananas
banana_radio = customtkinter.StringVar()
...
double_icecream = customtkinter.CTkRadioButton(waffle_cake_frame, text= "Double scoop", variable=icecream_radio).grid(row=1, column=3, padx=20, pady=20, columnspan=1)
confirm_classic = customtkinter.CTkButton(waffle_cake_frame, text= "confirm").grid(row=5, column=3, padx=20, pady=20, columnspan=1)
number_of_items_label = customtkinter.CTkLabel(waffle_cake_frame, text= "Number of items" )
number_of_items_label.grid(column=2, row=3, columnspan=3)
number_of_items = Spinbox(waffle_cake_frame, from_=1, to=1000000000,font=("Arial", 14), width=10)
number_of_items.grid(column=2, row=4, columnspan=3)
...
iced_choclate_frame = customtkinter.CTkScrollableFrame(app, width=750, border_width=2)
image9 = customtkinter.CTkImage(light_image=Image.open("chocolate.png"), size=(200,200))
image9_button = customtkinter.CTkButton(menu_page_frame, text="",fg_color= "white",hover_color="lightgray", image=image9, command= iced_choclate)
image9_button.grid(row=6, column=1)
#size
size_radio = customtkinter.StringVar()
normal = customtkinter.CTkRadioButton(iced_choclate_frame, text= "normal", variable=banana_radio).grid(row=0, column=1, padx=20, pady=20, sticky="ew", columnspan=1)
...
def smoothies():
    ...
    smoothies_frame.place(relx=0.5, rely=0.3, anchor="center")
smoothies_frame = customtkinter.CTkScrollableFrame(app, width=750, border_width=2)
image10 = customtkinter.CTkImage(light_image=Image.open("smoothies.png"), size=(200,200))
image10_button = customtkinter.CTkButton(menu_page_frame, text="",fg_color= "white",hover_color="lightgray", image=image10, command= smoothies )
image10_button.grid(row=6, column=3)
#flavours
flavours_label = customtkinter.CTkLabel(smoothies_frame, text= "flavours" )
flavours_label.grid(column=2, row=2, columnspan=3)
...
def slushies():
    ...
    slushies_label.grid(row=3, column=3)
slushies_label = customtkinter.CTkLabel(menu_page_frame, text="slushies")
image11 = customtkinter.CTkImage(light_image=Image.open("slushies.png"), size=(200,200))
image11_button = customtkinter.CTkButton(menu_page_frame, text="",fg_color= "white",hover_color="lightgray",command= slushies, image= image11 )
image11_button.grid(row=7, column=1)
