...
#email
email_entry = CTkEntry(login_page_frame, placeholder_text= "email", width=250).grid(column=0, row=1, columnspan=3)
#password
password_entry = CTkEntry(login_page_frame, placeholder_text= "password", width=250,show='*').grid(column=0, row=2, columnspan=3)

signup_button= CTkButton(login_page_frame, text="Sign Up", width=250, command=signup).grid(column=0, row=3, columnspan=3)
